...
contract FflonkVerifier {
    ...
    uint256 constant C0x  = 9537070771042594252442434003434215708185407661243662042986686832444688415069;
    uint256 constant C0y  = 55518705088339912088946670546856840630584654415492293484890517654573928316;

    // Verifier preprocessed input x·[1]_2
    uint256 constant X2x1 = 4536255468514386007608283605097307170320703676375711919046920796053609789984;
    uint256 constant X2x2 = 6776291576362538782348849379553559549340876722612301224058998826935626099748;
    uint256 constant X2y1 = 15119959841858956525214256663534298908109245078120403301423797908835479375928;
    uint256 constant X2y2 = 13995628994442322751521956883554455021849312196453699521740506772265992625206;
